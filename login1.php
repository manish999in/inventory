    ...
    <div class="login-container">
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide color-1">
                        <div class="slide-image">
                            <img src="img/web bg copy.jpg" loading="lazy" alt="" />
                        </div>
                        <div class="slide-content">
                            <h2>Login with your Employee Code and Password</h2>
                        </div>
                    </div>
        ...
        <div class="login-form">
            <div class="login-form-inner">
                ...
                <h1>Login</h1>
                <p class="body-text">Login with your Employee Code and Password</p>



                <div class="login-form-group">
                    <label for="email">Employee Code <span class="required-star">*</span></label>
                    <input type="text" value="SANS-00" id="text">
                </div>
                <div class="login-form-group">
                    <label for="pwd">Enter password <span class="required-star">*</span></label>
